...
component ->>+ userService: GetAuthenticationStateAsync()

note over component,userService: The specifics of request flow <br /> via Blazor internal tooling are <br /> omitted for the sake of brevity.

userService -->> userService: Acquire AuthenticationState <br /> using access token cookie

userService -->>- component: AuthenticationState
